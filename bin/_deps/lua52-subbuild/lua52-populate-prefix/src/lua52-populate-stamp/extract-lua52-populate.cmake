...
#
get_filename_component(filename "/home/runner/work/ElunaTrinityWotlk/ElunaTrinityWotlk/bin/_deps/lua52-subbuild/lua52-populate-prefix/src/lua-5.2.4.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/ElunaTrinityWotlk/ElunaTrinityWotlk/bin/_deps/lua52-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lua52-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lua52-populate${i}")
