...
#ifdef ELUNA
        Eluna::OnEquip(this, pItem2, bag, slot);
#endif
        return pItem2;
    }
...
#ifdef ELUNA
        Eluna::OnEquip(this, pItem, bag, slot);
#endif
    return pItem;
}
...
void Player::QuickEquipItem(uint16 pos, Item* pItem)
{
    if (pItem)
    {
        ...
        UpdateAchievementCriteria(ACHIEVEMENT_CRITERIA_TYPE_EQUIP_EPIC_ITEM, pItem->GetEntry(), slot);
#ifdef ELUNA
        Eluna::OnEquip(this, pItem, (pos >> 8), slot);
#endif
    }
}
...
#ifdef ELUNA
    if (!Eluna::OnChat(this, CHAT_MSG_SAY, language, _text))
        return;
#endif
...
#ifdef ELUNA
    if (!Eluna::OnChat(this, CHAT_MSG_YELL, language, _text))
        return;
#endif
...
#ifdef ELUNA
    if (!Eluna::OnChat(this, CHAT_MSG_EMOTE, LANG_UNIVERSAL, _text))
        return;
#endif
...
#ifdef ELUNA
    if (!Eluna::OnChat(this, CHAT_MSG_WHISPER, language, _text, rPlayer))
        return;
#endif
...
#ifdef ELUNA
        Eluna::OnLootItem(this, newitem, item->count, this->GetLootGUID());
#endif
    }
    else
