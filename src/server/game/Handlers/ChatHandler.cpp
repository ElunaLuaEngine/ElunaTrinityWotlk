...
#ifdef ELUNA
            if(!Eluna::OnChat(sender, type, lang, msg, group))
                return;
#endif
...
#ifdef ELUNA
                    if(!Eluna::OnChat(sender, type, lang, msg, guild))
                        return;
#endif
...
#ifdef ELUNA
                    if(!Eluna::OnChat(sender, type, lang, msg, chn))
                        return;
#endif
...
#ifdef ELUNA
                if(!Eluna::OnChat(sender, type, lang, msg))
                    return;
#endif
            }
            break;
