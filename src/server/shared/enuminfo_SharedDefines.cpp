...
TC_API_EXPORT EnumText EnumUtils<Races>::ToString(Races value)
{
    switch (value)
    {
        ...
        case RACE_PANDAREN_NEUTRAL: return { "RACE_PANDAREN_NEUTRAL", "Pandaren Neutral", "" };
        ...
        case RACE_LIGHTFORGED_DRAENEI: return { "RACE_LIGHTFORGED_DRAENEI", "Lightforded Draenei", "" };
        case RACE_ZANDALARI_TROLL: return { "RACE_ZANDALARI_TROLL", "Zandalari trol", "" };
        ...
        case RACE_MAGHAR_ORC: return { "RACE_MAGHAR_ORC", "Maghar Orc", "" };
        case RACE_MECHAGNOME: return { "RACE_MECHAGNOME", "MechanoGnome", "" };
...
template <>
TC_API_EXPORT size_t EnumUtils<Races>::Count() { return 28; }
...
TC_API_EXPORT Races EnumUtils<Races>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 25: return RACE_SETHRAK;
        case 26: return RACE_DRACTHYR;
        case 27: return RACE_EREDAR;
...
TC_API_EXPORT size_t EnumUtils<Races>::ToIndex(Races value)
{
    switch (value)
    {
        ...
        case RACE_SETHRAK: return 25;
        case RACE_DRACTHYR: return 26;
        case RACE_EREDAR: return 27;
        default: throw std::out_of_range("value");
    }
}
